...
export default function Clients() {
    ...
    useEffect(() => {
        if (todoList.length > 0) {
            localStorage.setItem('Clients', JSON.stringify(todoList))
        }
    ...
    <div>
        ...
        <div className='input'>
            <form className='form' onSubmit={preventDefault}>
                <input id="inputBox" type="text" placeholder='Enter Client Name' value={todo} onChange={(e) => {setTodo(e.target.value)}}/>
